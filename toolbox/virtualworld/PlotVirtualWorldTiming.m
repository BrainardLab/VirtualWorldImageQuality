function folderInfo = PlotVirtualWorldTiming(varargin)
%% Plot VirtualWorld execution times based on folder timestamps.
%
% folderInfo = PlotVirtualWorldTiming() examines several subfolders of
% the VirtualWorld project folder for modification timestamps and file
...
% parser.addParameter('workingFolder', fullfile(getpref('VirtualWorldImageQuality', 'outputDataFolder'),parser.Results.outputName), @ischar);
