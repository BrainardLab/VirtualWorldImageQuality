...
originalFolder = fullfile(getpref(projectName, 'outputDataFolder'),parser.Results.outputName,'Originals');
...
dataBaseDir = fullfile(getpref(projectName, 'outputDataFolder'),parser.Results.outputName,'Data');
illuminantsFolder = fullfile(getpref(projectName, 'outputDataFolder'),parser.Results.outputName,'Data','Illuminants','BaseScene');
...
otherObjectFolder = fullfile(getpref(projectName, 'outputDataFolder'),parser.Results.outputName,'Data','Reflectances','OtherObjects');
makeOtherObjectReflectance(nOtherObjectSurfaceReflectance,otherObjectFolder);
targetObjectFolder = fullfile(getpref(projectName, 'outputDataFolder'),parser.Results.outputName,'Data','Reflectances','TargetObjects');
