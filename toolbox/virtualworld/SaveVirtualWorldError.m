function SaveVirtualWorldError(recipeFolder, error, recipe, extra)
% Save error and recipe info to a standard folder.
%
% SaveVirtualWorldError(error, recipe) will save the given error info
...
% Virtual World runs, since save() is not allowed from directly inside
% parfor loops.
