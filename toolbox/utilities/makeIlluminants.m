function makeIlluminants(projectName, nIlluminances, folderToStore, minMeanIlluminantLevel, maxMeanIlluminantLevel)
...
%
% Input:
%   projectName = string giving project name, used in getpref calls
...
getpref(projectName,'inputDataFolder');
pathToIlluminanceData = fullfile(getpref(projectName,'inputDataFolder'),'IlluminantSpectra');
